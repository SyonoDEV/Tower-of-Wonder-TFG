...
<<<<<<< HEAD
  ...
  const scrollToPlatforms = (e) => {
    ...
    const el = document.getElementById('plataformas')
    ...
    <div className={styles.contenido}>
      ...
      <div className={styles.hero}>
        ...
        <p className={styles.heroText}>
          Sumérgete en un mundo de fantasía y aventura con nuestro nuevo videojuego.
          Explora paisajes impresionantes, enfrenta desafíos épicos y descubre secretos
          ocultos en cada rincón. ¡Únete a la comunidad de jugadores y vive la experiencia
          de Tower of Wonder hoy mismo!
        </p>
